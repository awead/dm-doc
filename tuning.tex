...
Pythagorean tuning presented another problem as well.  Not only was it not internally
...
Regular meantone temperaments contained a number of fifths that were all narrowed by the
...
The first theorist to use equal division was Vicentino who divided his octave into 31
...
Examining the 31-part system in more detail, let us take the C major scale as an example
...
according to its number of parts. \input{figures/custom/31-part-octave} Five wholetones at
...
Systems of equal division were not limited to just 31 parts.  The theorists Zarlino and Salinas describe the 19-division
...
In the sixteenth century, one could achieve equal temperament in two ways.  The first was
...
To express their intervals, we can use the same system of parts or commas that were
