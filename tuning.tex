...
\input{figures/custom/31-part-octave} Five wholetones at 5 parts apiece makes 25 parts, and adding
...
major scale divided into its chromatic and diatonic semitones. \input{figures/custom/31-part-octave-
complete} Chromatic semitones represent the shortest distance between two pitches, such as the
