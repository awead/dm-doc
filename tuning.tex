...
temperament has degraded the effect of music for which it was not originally intended.

It is not my purpose to extoll the virtues of one temperament over another.  The
matter is quite subjective, a fact supported by the vast number of temperaments
available to a lutenist during the sixteenth and seventeenth centuries.  While
some of these temperaments  conformed to the contemporary norms of meantone,
others resembled modern-day equal temperament.  Even then, equal  temperament
was not unknown, and historical fretting sources match it quite closely using
systems of equal division and other complex methods of dividing a string.  Its
use on other instruments was discouraged because of the consequences to harmony;
however, its favor with fretted instruments remained.  Before we can get to the
reasons why, we must first discuss the history of tuning and temperament, and
the main problem it poses to us.
...
apply to tuning; however, it was Aristoxenus and Ptolemy who began the debate about
tuning which still continues today.  One of the fundamental teachings of the
...
Ptolemy on the other hand continued with the Pythagorean notion of ratio, but
...
tuned in pure fifths, just like Pythagorean tuning, except one group was slightly
...
Usually this means shrinking the size of the fifth slightly so that it is narrower, or
...
favored more thirds. Depending on how much you flattened the fifth, you could
...
in the scale according to its number of parts. \input{figures/custom/31-part-octave}
...
\input{figures/custom/31-part-octave-complete} Chromatic semitones represent the
...
Technically speaking, equal temperament is a type of equal division where the octave is
...
Meantone temperament uses intervals that can be expressed using whole number ratios,
...
In order to effectively compare all these different kinds of semitones, we need to
