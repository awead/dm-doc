...
\input{figures/quarter-diatonic-complete}

\input{figures/quarter-diatonic-complete-a}

\chapter{Fret Placement Guide}

Below is a matrix of fret placements for any given mensur length.  Multiply your mensur length
for a given fret and temperament to find the distance from the nut to place your fret.
